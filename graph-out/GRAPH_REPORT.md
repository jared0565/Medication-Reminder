...
- `qrcode.js` — out 44 / in 0 (ratio 44.0)
...
- size: 87 (files: 2, functions: 62, classes: 0)
- members: `node_assert_strict`, `node_crypto`, `node_fs`, `node_test`, `node_vm`, `tests_test_web_sync`, `tests_test_web_sync_addeventlistener`, `tests_test_web_sync_alert`, `tests_test_web_sync_append`, `tests_test_web_sync_cancelanimationframe`, `tests_test_web_sync_close`, `tests_test_web_sync_control`, `tests_test_web_sync_createelement`, `tests_test_web_sync_detect`, `tests_test_web_sync_dialog` ...
### Community 0 (mixed)
- size: 86 (files: 5, functions: 7, classes: 1)
...
- size: 86 (files: 1, functions: 62, classes: 0)
- members: `tests_test_web_sync_add`, `tests_test_web_sync_getusermedia`, `tests_test_web_sync_showmodal`, `tests_test_web_sync_stop`, `web_app`, `web_app_active`, `web_app_addeventlistener_click_l28_c42`, `web_app_addmedicine_onclick_l14_c361`, `web_app_addmedicineinput`, `web_app_addschedule_onclick_l14_c318`, `web_app_alert`, `web_app_anon_l39_c765`, `web_app_atob`, `web_app_await`, `web_app_b_onclick_l14_c56` ...
### Community 7 (mixed)
...
### Community 3 (worker/src, functions)
- size: 1 (files: 0, functions: 1, classes: 0)
- members: `worker_src_index_map_l29_c42`
### Community 4 (files)
- size: 1 (files: 1, functions: 0, classes: 0)
...
- size: 1 (files: 1, functions: 0, classes: 0)
- members: `license`
### Community 8 (worker, files)
- size: 1 (files: 1, functions: 0, classes: 0)
- members: `worker_wrangler`
